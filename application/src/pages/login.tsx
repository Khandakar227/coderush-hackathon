    ...
    <div className='grid place-items-center custom-h bg-hero'>
        <form className='p-4 border shadow rounded-md'>
            ...
            <div className='w-full'>
                <button className='py-4 px-8 my-4 bg-black text-white rounded-md mx-auto w-full'> Login </button>
            </div>
            <Link href='/forgot-password'> <p className='my-4 text-blue-700'> Forgot Password? </p> </Link>
        </form>
    </div>
  )
}
